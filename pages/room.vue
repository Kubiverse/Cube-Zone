                    ...
                    <tbody>
                      ...
                      >
                        <td>
                          ...
                          >
                          <v-icon
                            v-if="item.cuber.pivot.type !== 'PARTICIPATING'"
                            small
                            title="Away"
                            >mdi-sleep</v-icon
                          >
        ...
        if (!foundResult) {
          !initialLoad &&
            this.handleChatMessageReceived({
              user: active_cuber,
              message:
                'has just joined the room! (' + active_cuber.pivot.type + ')',
              system: true,
            })
          ...
          !initialLoad &&
            this.handleChatMessageReceived({
              user: active_cuber,
              message: 'has just set status to: ' + active_cuber.pivot.type,
              system: true,
            })
