...
export const CREATE_ROOM_MUTATION = gql`
  mutation createRoom($name:String!, $description:String, $time_limit:Milliseconds, $time_target:Milliseconds, $max_capacity:Int, $is_public:Boolean, $event_id:ID!, $secret:String) {
    createRoom(input: {
      name: $name
...
export const UPDATE_ROOM_MUTATION = gql`
  mutation updateRoom($id:ID!, $name:String!, $description:String, $time_limit:Milliseconds, $time_target:Milliseconds, $max_capacity:Int) {
    updateRoom(input: {
      id: $id
      name: $name
      description: $description
...
export const UPDATE_SOLVE_MUTATION = gql`
  mutation updateSolve($solve_id:ID!, $state:SolveState!, $time:Milliseconds, $penalties:Milliseconds, $is_dnf:Boolean) {
    updateSolve(input: {
      id: $solve_id,
      state: $state,
      time: $time,
